...
transmod_params <- params_surv_list(create_params(m1Hesim2,uncertainty="none"),
                                    background,
                                    create_params(m2Hesim2,uncertainty="none"),
                                    background,
                                    create_params(m3Hesim2,uncertainty="none"))
