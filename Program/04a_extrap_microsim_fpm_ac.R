## Filename: 04a_extrap_microsim_fpm_ac
...
results <- lapply(treat_values, function(treat_value) {
    ...
    param <- list(treat = treat_value,
                  ...
                  m3 = gsm_design(m3_fpm_ac, newdata = ndata))
...
## Save results
saveRDS(results_FC, file = "../Data/04a_extrap_microsim_fpm_ac_FC.rds")
saveRDS(results_RFC, file = "../Data/04a_extrap_microsim_fpm_ac_RFC.rds")
################################################################
